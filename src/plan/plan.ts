...
export const PLAN: PlannedSession[] = [
  ...
  { id: "n5", date: "2026-09-07", kind: "chave", text: "FERIADO · VOTU circuito 21k — 18,7 km / 1.128 m · ~3h15" },
  { id: "n6", date: "2026-09-07", kind: "chave", text: "DEPOIS do circuito: 5 a 6 repetições de UM trecho técnico — sobe caminhando, desce forçando (~40')", why: "Você já está cansado: é a réplica exata dos km 37–59. É a sessão mais importante do plano." },
  { id: "n7", date: "2026-09-07", kind: "nutricao", text: "Ensaio geral: mochila, géis, sal, tênis, meia, roupa. Nada novo depois de hoje." },
  { id: "n8", date: "2026-09-07", kind: "nutricao", text: "60 g carbo/h · 500–700 ml/h · 800–1.000 mg sódio/h" },
  { id: "n1", date: "2026-09-07", kind: "perna", text: "Academia: não. 10' de mobilidade em casa.", why: "Depois de 4h de trilha, peso é ruído." },
  { id: "n9", date: "2026-09-07", kind: "nutricao", text: "Calor: hoje não. Depois de 4h de trilha é desidratação, não adaptação." },
  ...
  { id: "o3", date: "2026-09-08", kind: "nutricao", text: "Calor · 4 de 6 — 20' pós-treino" },

  { id: "p1", date: "2026-09-09", kind: "corrida", text: "Base 50' fácil" },
  { id: "p2", date: "2026-09-09", kind: "perna", text: "Perna · Força com negativas — última pesada antes de 12/09", exercises: ["Agachamento — 4 × 6 · negativa de 4s", "Leg press — 4 × 6 · negativa de 5s", "Step-down com halteres — 4 × 8 cada perna · desce em 4s", "Extensora excêntrica — 3 × 8 · sobe com 2 pernas, desce com 1", "Mesa flexora — 3 × 8 · negativa de 4s", "Isometria: búlgaro parado embaixo — 3 × 30s cada perna"] },
  { id: "p4", date: "2026-09-09", kind: "nutricao", text: "Calor · 5 de 6 — 20' pós-treino" },
  ...
  { id: "q3", date: "2026-09-10", kind: "nutricao", text: "Calor · 6 de 6 — última antes da prova" },
  ...
  { id: "s5", date: "2026-09-12", kind: "perna", text: "Academia: não. Dia de prova.", why: "Exceção 2 de 3." },
  ...
  { id: "t3", date: "2026-09-13", kind: "perna", text: "Academia: não. Prova ontem + longão hoje já é a semana dupla.", why: "Exceção 3 de 3." },

  { id: "u1", date: "2026-09-14", kind: "corrida", text: "Off completo — você vem de prova + longão" },
  { id: "u2", date: "2026-09-14", kind: "perna", text: "Academia: não. 10' de mobilidade em casa.", why: "Prova sábado + longão domingo. Peso hoje não constrói nada." },
  ...
  { id: "y4", date: "2026-09-18", kind: "perna", text: "Academia: não. Véspera de Paraty." },
  ...
  { id: "dt0907", date: "2026-09-07", kind: "nutricao", text: "Dieta · dia DURO — 3.100 kcal · 458 g carbo · 225 g proteína · 38 g gordura", exercises: ["Café: 2 ovos + 3 claras + 2 pães + tapioca de 60 g de goma", "Almoço: 200 g frango + 420 g arroz + 150 g feijão", "Lanche: 1,5 dose de whey + 2 bananas + 200 g mamão", "Jantar: 180 g frango + 420 g arroz"] },
